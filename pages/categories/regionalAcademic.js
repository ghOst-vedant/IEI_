          ...
          >
            <Tbody>
              <Tr>
                ...
                >
                  <NextLink
                    href="/categories/researchExcellenceStudent"
                    passHref
                  >
                    <Link>
              ...
              <Tr>
                <Td style={{ textAlign: "center", border: "1px solid black" }}>
                  <NextLink
                    href="/categories/academicExcellenceTeacher"
                    passHref
                  >
                    <Link>
                      <Text fontSize="2xl" fontWeight="bold" color="black">
              ...
              <Tr>
                <Td style={{ textAlign: "center", border: "1px solid black" }}>
                  <NextLink
                    href="/categories/academicExcellencePrincipal"
                    passHref
                  >
                    <Link>
                      <Text fontSize="2xl" fontWeight="bold" color="black">
                ...
                <Td style={{ textAlign: "center", border: "1px solid black" }}>
                  <NextLink
                    href="/categories/academicExcellenceInstitute"
                    passHref
                  >
                    <Link>
                      <Text fontSize="2xl" fontWeight="bold" color="black">
