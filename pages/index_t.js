...
export default function Home() {
  return (
    <div>
        ...
        <Flex width={"100%"} >
          ...
          <Box width={"100%"} boxShadow='outline' p='6' rounded='md'>
            ...
            <marquee behavior="scroll" direction="left" style={{ width: '100%' }}>
              ...
              <b style={{ fontSize: '17px' }}> All Awardees (Winners, Runners and Special Recognition) Will Recieve a Trophy and Certificate  Award Ceremony is preponed to 15th September 2023. 
                Click here to view awardees :<a href="https://shorturl.at/sGRU2" style={{ color: 'blue' }} target="_blank">https://shorturl.at/sGRU2</a></b>
             </marquee>
      ...
      <Text style={{ color: "red", margin: "10px 30px", fontSize: "17px", fontWeight: "bold" }}><b>Note: Dear Applicants,
        It is crucial to note that acknowledgement mails have been sent from the email address <a href="mailto:supportiei@fcrit.ac.in" style={{ padding: " 0 5px", color: "blue" }}>supportiei@fcrit.ac.in</a>
        If you have not received an acknowledgement, please make sure to contact us immediately at the aforementioned email address.</b></Text>
      <br />
