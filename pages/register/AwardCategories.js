    ...
    return (
        <FormControl isRequired>
            ...
            <Select id="Category" onChange={onChange}>
                ...
                <option value="RE (Divyang-student) ">RE (Divyang-student) </option>
                <option value="RE (Teaching faculty) ">RE (Teaching faculty) </option>
                <option value="RE (Industry/ Govt. Organization/Consultancy Firm)">RE (Industry/ Govt. Organization/Consultancy Firm)</option>
                <option value="AE (Student) ">AE (Student) </option>
                <option value="AE (Divyang-Student) ">AE (Divyang-Student) </option>
                <option value="AE (Teaching Faculty) ">AE (Teaching Faculty) </option>
                <option value="AE (HoD) ">AE (HoD) </option>
                <option value="AE (Principal/Director) ">AE (Principal/Director) </option>
